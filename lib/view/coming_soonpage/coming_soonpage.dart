        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) => FirstcustomCard(
                title1: DataBase.comingsoondatas[index]["title1"].toString(),
                title2: DataBase.comingsoondatas[index]["title2"].toString(),
                title3: DataBase.comingsoondatas[index]["title3"].toString(),
                imageurl:
